...
type HydraideServiceClient interface {
	...
	// ShiftExpiredTreasuresMany batches several ShiftExpiredTreasures
	...
	// hashing on Swamp name); this RPC is per-server. Use it for
	...
	// PatchTreasures atomically applies one or more field-level mutations to
	// MessagePack-encoded Treasures within a single swamp.
	//
	// Each TreasurePatch targets a single key and carries a list of typed ops
	// (SET / DELETE / INC / APPEND / PREPEND / REMOVE_AT / REMOVE_VAL / MERGE)
	// applied under a per-key guard. Atomicity is per-key: ops within one
	// patch either all commit or none. Cross-key atomicity is intentionally
	// not provided.
	//
	// The server walks the existing msgpack blob structurally and splices in
	// pre-encoded values, so untouched fields keep their exact wire encoding
	// (e.g. int8 stays int8, time.Time stays its canonical extension form).
	//
	// Use this to replace client-side Lock + Load + Mutate + Save round-trips
	...
	// PatchTreasuresMany batches several PatchTreasures operations against
	// multiple swamps on the same server in a single RPC. Each Requests
	// entry is dispatched independently under its own per-swamp guard;
	// the response carries one PatchTreasuresResponse per request, in
	// input order, paired with an optional swamp-level Error field.
	//
	// Per-swamp errors do not abort the batch (e.g. an invalid swamp name
	// on one entry leaves the others to complete). Per-key statuses
	// (KEY_NOT_FOUND, CONDITION_NOT_MET, TYPE_MISMATCH, etc.) continue to
	// surface as PatchResult.StatusCode entries inside each per-swamp
	// PatchTreasuresResponse.
	//
	// The SDK groups multi-swamp batches by destination server (consistent
	// hashing on Swamp name); this RPC is per-server. Use it for return
	// flows where a single worker writes patched results into several
	// sharded swamps in one round-trip (e.g. crawler results that touch
	// a TLD-sharded domain-state swamp).
	PatchTreasuresMany(ctx context.Context, in *PatchTreasuresManyRequest, opts ...grpc.CallOption) (*PatchTreasuresManyResponse, error)
	...
	// PatchExpiredTreasuresMany batches several PatchExpiredTreasures
	// operations against multiple swamps on the same server in a single
	// RPC. Each Requests entry is dispatched independently under its own
	// per-swamp guard; the response carries one PatchExpiredTreasuresResponse
	// per request, in input order.
	//
	// Per-swamp errors do not abort the batch: a swamp that fails to summon
	// or reports a missing Ops/Meta combination still produces a response
	// entry (empty Patched + populated Error field on the per-treasure
	// record where applicable), so callers can react to partial outcomes
	// without re-issuing every other request.
	//
	// The SDK groups multi-swamp requests by the destination server first
	// (consistent hashing on Swamp name), so this RPC is per-server. The
	// client then merges per-server responses into a single iterator
	// callback. Use this RPC for combined queue-claim flows where one
	// worker pulls leases from several ready swamps in proportion (e.g. a
	// crawler that takes 80% of its work from the direct queue and 20%
	// from the proxy queue).
	PatchExpiredTreasuresMany(ctx context.Context, in *PatchExpiredTreasuresManyRequest, opts ...grpc.CallOption) (*PatchExpiredTreasuresManyResponse, error)
...
func (c *hydraideServiceClient) ShiftExpiredTreasuresMany(ctx context.Context, in *ShiftExpiredTreasuresManyRequest, opts ...grpc.CallOption) (*ShiftExpiredTreasuresManyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *hydraideServiceClient) PatchTreasures(ctx context.Context, in *PatchTreasuresRequest, opts ...grpc.CallOption) (*PatchTreasuresResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *hydraideServiceClient) PatchTreasuresMany(ctx context.Context, in *PatchTreasuresManyRequest, opts ...grpc.CallOption) (*PatchTreasuresManyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PatchTreasuresManyResponse)
	err := c.cc.Invoke(ctx, HydraideService_PatchTreasuresMany_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hydraideServiceClient) PatchExpiredTreasuresMany(ctx context.Context, in *PatchExpiredTreasuresManyRequest, opts ...grpc.CallOption) (*PatchExpiredTreasuresManyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PatchExpiredTreasuresManyResponse)
	err := c.cc.Invoke(ctx, HydraideService_PatchExpiredTreasuresMany_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HydraideServiceServer interface {
	...
	// sharded swamps in one round-trip (e.g. crawler results that touch
	// a TLD-sharded domain-state swamp).
	PatchTreasuresMany(context.Context, *PatchTreasuresManyRequest) (*PatchTreasuresManyResponse, error)
	// PatchExpiredTreasures atomically selects up to HowMany expired treasures
	// from a swamp and applies the same op-set + meta to each one in place.
	//
	// Selection is by ExpiredAt < server-now, oldest-first, exactly like
	...
	// crawler that takes 80% of its work from the direct queue and 20%
	// from the proxy queue).
	PatchExpiredTreasuresMany(context.Context, *PatchExpiredTreasuresManyRequest) (*PatchExpiredTreasuresManyResponse, error)
	// SubscribeToTelemetry opens a real-time stream of all gRPC calls and their results.
	//
	// Each event includes:
	// - Timestamp and duration
...
func (UnimplementedHydraideServiceServer) RegisterSwamp(context.Context, *RegisterSwampRequest) (*RegisterSwampResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterSwamp not implemented")
}
func (UnimplementedHydraideServiceServer) DeRegisterSwamp(context.Context, *DeRegisterSwampRequest) (*DeRegisterSwampResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeRegisterSwamp not implemented")
}
...
func (UnimplementedHydraideServiceServer) GetByIndex(context.Context, *GetByIndexRequest) (*GetByIndexResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetByIndex not implemented")
}
func (UnimplementedHydraideServiceServer) GetByKeys(context.Context, *GetByKeysRequest) (*GetByKeysResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetByKeys not implemented")
}
func (UnimplementedHydraideServiceServer) ShiftByKeys(context.Context, *ShiftByKeysRequest) (*ShiftByKeysResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ShiftByKeys not implemented")
}
func (UnimplementedHydraideServiceServer) ShiftExpiredTreasures(context.Context, *ShiftExpiredTreasuresRequest) (*ShiftExpiredTreasuresResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ShiftExpiredTreasures not implemented")
}
...
func (UnimplementedHydraideServiceServer) DestroyBulk(grpc.BidiStreamingServer[DestroyBulkRequest, DestroyBulkResponse]) error {
	return status.Error(codes.Unimplemented, "method DestroyBulk not implemented")
}
...
func (UnimplementedHydraideServiceServer) IsSwampExist(context.Context, *IsSwampExistRequest) (*IsSwampExistResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IsSwampExist not implemented")
}
func (UnimplementedHydraideServiceServer) IsKeyExist(context.Context, *IsKeyExistRequest) (*IsKeyExistResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IsKeyExist not implemented")
}
func (UnimplementedHydraideServiceServer) AreKeysExist(context.Context, *AreKeysExistRequest) (*AreKeysExistResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AreKeysExist not implemented")
}
...
func (UnimplementedHydraideServiceServer) SubscribeToInfo(*SubscribeToInfoRequest, grpc.ServerStreamingServer[SubscribeToInfoResponse]) error {
	return status.Error(codes.Unimplemented, "method SubscribeToInfo not implemented")
}
func (UnimplementedHydraideServiceServer) Uint32SlicePush(context.Context, *AddToUint32SlicePushRequest) (*AddToUint32SlicePushResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Uint32SlicePush not implemented")
}
func (UnimplementedHydraideServiceServer) Uint32SliceDelete(context.Context, *Uint32SliceDeleteRequest) (*Uint32SliceDeleteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Uint32SliceDelete not implemented")
}
func (UnimplementedHydraideServiceServer) Uint32SliceSize(context.Context, *Uint32SliceSizeRequest) (*Uint32SliceSizeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Uint32SliceSize not implemented")
}
func (UnimplementedHydraideServiceServer) Uint32SliceIsValueExist(context.Context, *Uint32SliceIsValueExistRequest) (*Uint32SliceIsValueExistResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Uint32SliceIsValueExist not implemented")
}
func (UnimplementedHydraideServiceServer) IncrementInt8(context.Context, *IncrementInt8Request) (*IncrementInt8Response, error) {
	return nil, status.Error(codes.Unimplemented, "method IncrementInt8 not implemented")
}
func (UnimplementedHydraideServiceServer) IncrementInt16(context.Context, *IncrementInt16Request) (*IncrementInt16Response, error) {
	return nil, status.Error(codes.Unimplemented, "method IncrementInt16 not implemented")
}
func (UnimplementedHydraideServiceServer) IncrementInt32(context.Context, *IncrementInt32Request) (*IncrementInt32Response, error) {
	return nil, status.Error(codes.Unimplemented, "method IncrementInt32 not implemented")
}
func (UnimplementedHydraideServiceServer) IncrementInt64(context.Context, *IncrementInt64Request) (*IncrementInt64Response, error) {
	return nil, status.Error(codes.Unimplemented, "method IncrementInt64 not implemented")
}
func (UnimplementedHydraideServiceServer) IncrementUint8(context.Context, *IncrementUint8Request) (*IncrementUint8Response, error) {
	return nil, status.Error(codes.Unimplemented, "method IncrementUint8 not implemented")
}
func (UnimplementedHydraideServiceServer) IncrementUint16(context.Context, *IncrementUint16Request) (*IncrementUint16Response, error) {
	return nil, status.Error(codes.Unimplemented, "method IncrementUint16 not implemented")
}
func (UnimplementedHydraideServiceServer) IncrementUint32(context.Context, *IncrementUint32Request) (*IncrementUint32Response, error) {
	return nil, status.Error(codes.Unimplemented, "method IncrementUint32 not implemented")
}
func (UnimplementedHydraideServiceServer) IncrementUint64(context.Context, *IncrementUint64Request) (*IncrementUint64Response, error) {
	return nil, status.Error(codes.Unimplemented, "method IncrementUint64 not implemented")
}
func (UnimplementedHydraideServiceServer) IncrementFloat32(context.Context, *IncrementFloat32Request) (*IncrementFloat32Response, error) {
	return nil, status.Error(codes.Unimplemented, "method IncrementFloat32 not implemented")
}
func (UnimplementedHydraideServiceServer) IncrementFloat64(context.Context, *IncrementFloat64Request) (*IncrementFloat64Response, error) {
	return nil, status.Error(codes.Unimplemented, "method IncrementFloat64 not implemented")
}
...
func (UnimplementedHydraideServiceServer) PatchTreasuresMany(context.Context, *PatchTreasuresManyRequest) (*PatchTreasuresManyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PatchTreasuresMany not implemented")
}
...
func (UnimplementedHydraideServiceServer) PatchExpiredTreasuresMany(context.Context, *PatchExpiredTreasuresManyRequest) (*PatchExpiredTreasuresManyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PatchExpiredTreasuresMany not implemented")
}
...
func (UnimplementedHydraideServiceServer) GetTelemetryHistory(context.Context, *TelemetryHistoryRequest) (*TelemetryHistoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTelemetryHistory not implemented")
}
func (UnimplementedHydraideServiceServer) GetErrorDetails(context.Context, *ErrorDetailsRequest) (*ErrorDetailsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetErrorDetails not implemented")
}
func (UnimplementedHydraideServiceServer) GetTelemetryStats(context.Context, *TelemetryStatsRequest) (*TelemetryStatsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTelemetryStats not implemented")
}
func (UnimplementedHydraideServiceServer) GetByIndexStream(*GetByIndexStreamRequest, grpc.ServerStreamingServer[GetByIndexStreamResponse]) error {
	return status.Error(codes.Unimplemented, "method GetByIndexStream not implemented")
}
func (UnimplementedHydraideServiceServer) GetByIndexStreamFromMany(*GetByIndexStreamFromManyRequest, grpc.ServerStreamingServer[GetByIndexStreamFromManyResponse]) error {
	return status.Error(codes.Unimplemented, "method GetByIndexStreamFromMany not implemented")
}
func (UnimplementedHydraideServiceServer) CompactSwamp(context.Context, *CompactSwampRequest) (*CompactSwampResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CompactSwamp not implemented")
}
...
func RegisterHydraideServiceServer(s grpc.ServiceRegistrar, srv HydraideServiceServer) {
	// If the following call panics, it indicates UnimplementedHydraideServiceServer was
...
func _HydraideService_ShiftExpiredTreasuresMany_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShiftExpiredTreasuresManyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HydraideServiceServer).ShiftExpiredTreasuresMany(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HydraideService_ShiftExpiredTreasuresMany_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HydraideService_PatchTreasures_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PatchTreasuresRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HydraideServiceServer).PatchTreasures(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HydraideService_PatchTreasures_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HydraideServiceServer).PatchTreasures(ctx, req.(*PatchTreasuresRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _HydraideService_PatchTreasuresMany_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PatchTreasuresManyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HydraideServiceServer).PatchTreasuresMany(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HydraideService_PatchTreasuresMany_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HydraideServiceServer).PatchTreasuresMany(ctx, req.(*PatchTreasuresManyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HydraideService_PatchExpiredTreasuresMany_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PatchExpiredTreasuresManyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HydraideServiceServer).PatchExpiredTreasuresMany(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HydraideService_PatchExpiredTreasuresMany_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HydraideServiceServer).PatchExpiredTreasuresMany(ctx, req.(*PatchExpiredTreasuresManyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HydraideService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PatchTreasuresMany",
			Handler:    _HydraideService_PatchTreasuresMany_Handler,
		},
		{
		...
		{
			MethodName: "PatchExpiredTreasuresMany",
			Handler:    _HydraideService_PatchExpiredTreasuresMany_Handler,
		},
		{
